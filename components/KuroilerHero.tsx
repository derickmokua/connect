            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    <div className="w-full md:w-1/2 md:order-1 flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <p className="text-lg md:text-xl text-[#78350F] mb-10 leading-relaxed max-w-xl opacity-90 font-medium">
                        ...
                        {/* Social Proof */}
                        <div className="flex flex-wrap justify-center md:justify-start gap-4 md:gap-8 mb-8 border-t border-[#D97706]/10 pt-6 w-full">
                        ...
                        <p className="mt-4 text-sm text-[#78350F]/70 font-medium w-full text-center md:text-left">
