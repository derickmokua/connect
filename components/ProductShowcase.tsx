...
const products = {
    chicks: [
        { id: 'c1', title: 'Day Old', price: 110, image: '/images/chick.png', features: ['Cheapest Entry Point', 'Requires Brooder', 'High Potential'], desc: 'Freshly hatched. Needs 24/7 heat and care.', recommended: false },
        { id: 'c2', title: '1 Week Old', price: 130, image: '/images/chick.png', features: ['1st Gumboro Done', 'Active & Alert', 'Starter Feed'], desc: 'Past the critical first few days.', recommended: false },
        { id: 'c3', title: '2 Weeks Old', price: 160, image: '/images/chick.png', features: ['Strong Immunity', 'Gumboro Vaccinated', 'Needs Less Heat'], desc: 'Growing fast and past high mortality risk.', recommended: false },
        { id: 'c4', title: '3 Weeks Old', price: 190, image: '/images/chick.png', features: ['Newcastle Vaccinated', 'Feathering Well', 'Active Foraging'], desc: 'Robust and almost ready for hardening.', recommended: false },
        { id: 'c5', title: '4 Weeks Old', price: 250, image: '/images/hen.png', features: ['No Heat Needed', 'Free-Range Ready', 'High Survival Rate'], desc: 'Hardened. Ready for the outside coop.', recommended: true }
    ],
    mature: [
        { id: 'm1', title: 'Mature Hen', price: 1000, image: '/images/hen.png', features: ['Ready to Lay', 'Great for Meat', 'Fully Grown'], desc: 'Perfect for immediate egg production or meat.', recommended: false },
        { id: 'm2', title: 'Mature Cock', price: 1500, image: '/images/cock.png', features: ['Breeding Stock', 'Heavy Weight', 'Flock Leader'], desc: 'Superior genetics for breeding your flock.', recommended: true }
    ],
    eggs: [
        { id: 'e1', title: 'Table Eggs', price: 500, image: '/images/egg.png', features: ['Freshly Collected', 'Yellow Yolk', 'Organic'], desc: 'Delicious, nutritious eggs for your table.', recommended: false, unit: ' / Tray' },
        { id: 'e2', title: 'Fertilized Eggs', price: 1000, image: '/images/egg.png', features: ['High Hatch Rate', 'Kuroiler Genetics', 'Selected Daily'], desc: 'Ready for incubation. Start your own flock.', recommended: true, unit: ' / Tray' }
    ]
};
    ...
    return (
        <section id="products" className="py-20 px-4 bg-[#FAFAFA]">
            ...
            <div className="max-w-7xl mx-auto mb-16 text-center">
                ...
                <p className="text-[#6B7280] text-lg max-w-2xl mx-auto">Browse our complete range of quality poultry goods.</p>
            </div>
...
function ProductCard({ product }: { product: any }) {
    return (
        ...
        >
            ...
            <div className="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-white shadow-sm group-hover:scale-110 transition-transform duration-300 mt-4 z-10 relative overflow-hidden border border-slate-100 p-2">
                <img src={product.image} alt={product.title} className="w-full h-full object-cover mix-blend-multiply scale-125" />
            </div>
